...
const TiptapEditor = ({ content = '', onChange })=>{
    _s();
    const [thumbnailUrl, setThumbnailUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null); // 현재 썸네일 이미지 URL
...
_s(TiptapEditor, "4hq3DyL28QktmIxzey9G7LI1ruI=", false, function() {
    return [
...
async function deleteFeed(postId) {
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["BLOGSERVICE_API"]}/delete/post?postId=${postId}`;
    const response = await fetch(url, {
        method: "DELETE"
    });
    if (response.ok) {
...
async function readPost(postId) {
    ...
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["BLOGSERVICE_API"]}/readpost?postId=${postId}`;
    const response = await fetch(url, {
        method: "GET"
    });
    if (response.ok) {
...
async function addTagToPost(postId, tagName) {
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["BLOGSERVICE_API"]}/tag/add?postId=${postId}&tagName=${encodeURIComponent(tagName)}`;
    const response = await fetch(url, {
        method: "POST"
    });
    if (response.ok) {
...
async function addTagsToPost(postId, tagNames) {
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["BLOGSERVICE_API"]}/tags/add?postId=${postId}`;
    const response = await fetch(url, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
...
async function removeTagFromPost(postId, tagName) {
    const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["BLOGSERVICE_API"]}/tag/remove?postId=${postId}&tagName=${encodeURIComponent(tagName)}`;
    const response = await fetch(url, {
        method: "DELETE"
    });
    if (response.ok) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/jsx-dev-runtime.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/router.js [client] (ecmascript)"); // Pages Router용 훅
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$TiptapEditor$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/component/TiptapEditor.tsx [client] (ecmascript)"); // 에디터 컴포넌트
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$blogService$2f$blog$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/blogService/blog.ts [client] (ecmascript)"); // API 함수
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$write$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/styles/blogService/write.module.css [client] (css module)"); // CSS 모듈
;
var _s = __turbopack_context__.k.signature();
;
;
...
const WritePage = ({ postId })=>{
    ...
    const [tags, setTags] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]); // 태그 배열
    const [tagInput, setTagInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(''); // 태그 입력 필드
    const [thumbnail, setThumbnail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [isInitialLoad, setIsInitialLoad] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false); // 초기 데이터 로드 플래그
    // 3. [수정 모드] 데이터 로드 로직
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (postId) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$blogService$2f$blog$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["updatePost"])(postId, userSignId, updateData);
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$blogService$2f$blog$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["writeFeed"])(formData, userSignId);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        style: !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$write$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__["default"].tagInputGroup ? {
                            marginBottom: '20px'
                        } : undefined,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                style: !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$write$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__["default"].tagList ? {
                                    display: 'flex',
                                    flexWrap: 'wrap',
                                    gap: '8px',
                                    marginBottom: '8px'
                                ...
                                children: tags.map((tag)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        style: !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$write$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__["default"].tagItem ? {
                                            background: '#f1f3f5',
                                            padding: '4px 8px',
                                            borderRadius: '4px',
                                            display: 'flex',
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                style: !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$write$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__["default"].removeTagBtn ? {
                                                    border: 'none',
                                                    background: 'none',
                                                    cursor: 'pointer',
                                                    marginLeft: '4px'
...
_s(WritePage, "ymVs6eoU4wC0tdsQbbdlX9Tvtfk=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90bf03a3._.js.map