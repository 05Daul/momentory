...
"[project]/src/component/chatService/ChatPage.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatPage({ currentUserId, currentUserName }) {
    ...
    // 로그인 상태 체크 (currentUserId가 빈 문자열 ""일 경우 로그인 필요)
    if (!currentUserId) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$layout$2f$MainLayout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    children: "로그인이 필요한 서비스입니다. (ID가 없습니다)"
                }, void 0, false, {
                    fileName: "[project]/src/component/chatService/ChatPage.tsx",
                    lineNumber: 32,
                    columnNumber: 13
                }, this)
            }, void 0, false, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$chatService$2f$ChatPage$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/component/chatService/ChatPage.tsx [client] (ecmascript)");
;
;
;
async function Page() {
    const headerList = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$client$5d$__$28$ecmascript$29$__["headers"])();
    console.log("=======================================");
    console.log("🔍 Next.js Request Headers (Server Log) 🔍");
    const allHeaders = {};
    ...
    console.log("=======================================");
    // ✅ WritePage처럼 localStorage에서 가져오는 방식이 아닌,
    // 서버 헤더에서 가져오거나 기본값을 설정
    let userSignId = headerList.get("userSignId") || headerList.get("x-user-id") || "";
    // ✅ userName도 헤더에서 시도
    let userName = headerList.get("x-user-name") || headerList.get("userName") || userSignId || "사용자";
    try {
        userName = decodeURIComponent(userName);
    } catch (e) {
    // 디코딩 실패 시 원본 사용
    }
    // ⚠️ 서버 컴포넌트에서는 localStorage 접근 불가
    // 클라이언트에서 처리하도록 빈 값 전달
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$component$2f$chatService$2f$ChatPage$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
        currentUserId: userSignId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f270da01._.js.map