...
(()=>{
    const e = new Error("Cannot find module '@/styles/chatService/StartNewChatModal.module.css'");
...
function StartNewChatModal({ currentUserId, onClose, onRoomCreated }) {
        ...
        "StartNewChatModal.useEffect": ()=>{
            const loadFriends = {
                "StartNewChatModal.useEffect.loadFriends": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$userService$2f$friends$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getFriendList"])();
                        setFriends(data);
                    } catch (err) {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const newRoom = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$chatService$2f$chat$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["createChatRoom"])(participantIds, finalName);
            onRoomCreated({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fddb1d2f._.js.map