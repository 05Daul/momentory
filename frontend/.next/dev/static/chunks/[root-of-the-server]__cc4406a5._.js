...
(()=>{
    const e = new Error("Cannot find module '@/styles/userService/settings.module.css'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$userService$2f$user$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/userService/user.ts [client] (ecmascript)");
// getImageUrl, getInitial 유틸리티는 사용자의 기존 코드 베이스에 있다고 가정합니다.
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/imageUtils.ts [client] (ecmascript)");
;
...
const ProfileSettings = ({ initialProfile, onProfileUpdate })=>{
    ...
    // 닉네임 및 이메일 상태 (일반 정보 수정 기능 추가를 위해)
    ...
    const handleFileChange = async (e)=>{
        ...
        try {
            ...
            onProfileUpdate(updatedProfile); // 상위 컴포넌트 상태 업데이트
    ...
    // 일반 정보 (닉네임/이메일) 수정 처리 (백엔드 API가 있다고 가정)
    // 🚨 주의: UpdateUserDto의 password 필드 때문에 이 기능은 현재 백엔드 구조에서는 복잡함
    // 여기서는 이미지 업데이트만 집중하고, 일반 정보 수정은 잠시 보류합니다.
    /*
  const handleProfileSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (nickName === profile.nickName && email === profile.email) return;

    // TODO: updateUser(UpdateUserDto) API 호출 로직 구현
    // 현재 DTO 구조 문제로 인해 실제 구현 시 보안 이슈(비밀번호 필요)가 있음.
    alert("닉네임/이메일 수정 기능은 현재 백엔드 구조를 변경해야 구현 가능합니다.");
  };
  */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: styles.userInfoDisplay,
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: styles.userSignId,
                        children: [
                            "아이디: @",
                            profile.userSignId
                        ]
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form" /* onSubmit={handleProfileSubmit} */ , {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "닉네임과 이메일 변경은 현재 백엔드 구조상 제한될 수 있습니다."
                            }, void 0, false, {
                                fileName: "[project]/src/pages/setting.tsx",
                                lineNumber: 134,
                                columnNumber: 13
...
_s(ProfileSettings, "mn/ktW4pZWsOzISnWitdysZ5BCk=");
_c = ProfileSettings;
// === 2. 비밀번호 변경 컴포넌트 ===
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        children: "새 비밀번호 (8자 이상, 특수문자 포함 권장)"
                    }, void 0, false, {
                        fileName: "[project]/src/pages/setting.tsx",
                        lineNumber: 204,
                        columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc4406a5._.js.map