...
// CommentItem 컴포넌트
const CommentItem = ({ comment, currentUserSignId, replyingTo, setReplyingTo, editingCommentId, setEditingCommentId, onReply, onEdit, onDelete, isLoading, depth = 0 })=>{
    _s();
    ...
    const [isRepliesVisible, setIsRepliesVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(depth === 0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    comment.profileImg && !imageLoadError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                        src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getImageUrl"])(comment.profileImg),
                        alt: comment.userId,
                        ...
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$commentSection$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__["default"].commentAvatar,
                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getInitial"])(comment.userId)
                    }, void 0, false, {
                        fileName: "[project]/src/component/blogService/CommentSection.tsx",
                        lineNumber: 139,
                        columnNumber: 15
            ...
            comment.replies.length > 0 && isRepliesVisible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: comment.replies.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CommentItem, {
                        comment: r,
...
_s(CommentItem, "w5F+t5CL1EikalkTkYCqUBjBHVk=");
_c = CommentItem;
// 트리 업데이트 유틸
...
function CommentSection({ postId, comments: ssrComments = [] }) {
    ...
    const fetchProfiles = async (commentList)=>{
        // 1. 모든 댓글 및 대댓글에서 userId 수집
        const collectUserIds = (cmts)=>{
            const ids = new Set();
            const traverse = (c)=>{
                ids.add(c.userId);
        ...
        if (userIds.length === 0) return commentList;
        try {
            // 2. user.ts의 getUserProfiles 호출 (Map 반환)
            const profileMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$userService$2f$user$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getUserProfiles"])(userIds);
            // 3. 댓글 트리에 프로필 이미지 매핑
            const mapProfileToComment = (cmt)=>{
                const userProfile = profileMap.get(cmt.userId);
                return {
                    ...cmt,
                    profileImg: userProfile?.profileImg || null,
                    replies: cmt.replies.map(mapProfileToComment)
                };
            };
    ...
    const handleSubmitComment = async ()=>{
        ...
        try {
            ...
            const newCmtWithProfile = profiles.length > 0 ? profiles[0] : newCmt;
            setComments((prev)=>[
                    newCmtWithProfile,
                    ...prev
                ]);
    ...
    const handleReply = async (parentId, content)=>{
        ...
        try {
            ...
            const enrichedComment = profiles.length > 0 ? profiles[0] : newCmt;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a88c9b69._.js.map