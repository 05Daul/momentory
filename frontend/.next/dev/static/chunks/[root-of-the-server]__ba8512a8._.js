...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$blogService$2f$MyPosts$2e$module$2e$css__$5b$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/styles/blogService/MyPosts.module.css [client] (css module)"); // 새로 만들 스타일 파일
;
        ...
        "MyPostsPage.useEffect": ()=>{
            ...
            const fetchPosts = {
                "MyPostsPage.useEffect.fetchPosts": async (page)=>{
                    ...
                    try {
                        // API 호출
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$blogService$2f$blog$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getMyPosts"])(authorId, page);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba8512a8._.js.map