...
async function getUserProfiles(userSignIds) {
    ...
    try {
        // UserController.java의 @PostMapping("/profiles/batch") 호출
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$env$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["USERSERVICE_API"]}/profiles/batch`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        if (!response.ok) {
            console.error(`프로필 일괄 조회 실패: ${response.status}`);
            return profileMap;
        }
        // 백엔드 응답: List<Map<String, Object>> 형태
        const data = await response.json();
        // 응답 리스트를 Map으로 변환 (key: userSignId)
        data.forEach((profile)=>{
            profileMap.set(profile.userSignId, profile);
        });
    } catch (error) {
        console.error('프로필 일괄 조회 중 오류:', error);
    }
    return profileMap;
}
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: profileImg && !imageLoadError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        ...
                                        lineNumber: 104,
                                        columnNumber: 25
                                    }, this) : // profileImg가 없거나 로드 에러가 발생하면 아이디 첫글자 표시
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Topbar, "EyxoqXVyY4h+7OgYXEDj/adtvAU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f43522a._.js.map