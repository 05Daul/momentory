...
(()=>{
    const e = new Error("Cannot find module '../styles/TiptapEditor.module.css'");
...
function preserveSpacesInHTML(html) {
    return html.replace(/<p><\/p>/g, '<p>&nbsp;</p>').replace(/<p>\s*<\/p>/g, '<p>&nbsp;</p>').replace(/(<p[^>]*>)(\s+)/g, (match, tag, spaces)=>{
        ...
        input.onchange = async (event)=>{
            ...
            if (file) {
                try {
                    ...
                    // ✅ [오류 수정] result 객체에서 .url 속성을 직접 가져옵니다.
                    // (API 타입 정의에 따라 .data.imageUrl 대신 .url 사용)
...
const TiptapEditor = ({ content, onChange })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (editor && editor.getHTML() !== content) {
            // ✅ [오류 수정] boolean 대신 { emitUpdate: false } 객체를 사용합니다.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c1184ad._.js.map